...
namespace AtecaAPI.Migrations
{
    ...
    [Migration("20250530172624_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AtecaAPI.Models.Entity.Administrador", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AtecaAPI.Models.Entity.AppUser", b =>
                {
            ...
            modelBuilder.Entity("AtecaAPI.Models.Entity.DiaNoLectivo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AtecaAPI.Models.Entity.GrupoClase", b =>
                {
                    ...
                    b.ToTable("GruposClase");
                });

            modelBuilder.Entity("AtecaAPI.Models.Entity.Profesor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AtecaAPI.Models.Entity.Administrador", b =>
                {
                    b.HasOne("AtecaAPI.Models.Entity.AppUser", "AppUser")
                        .WithOne()
                        .HasForeignKey("AtecaAPI.Models.Entity.Administrador", "AppUserId")
            ...
            modelBuilder.Entity("AtecaAPI.Models.Entity.Reserva", b =>
                {
                    ...
                    b.HasOne("AtecaAPI.Models.Entity.Profesor", "Profesor")
                        .WithMany("Reservas")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AtecaAPI.Models.Entity.AppUser", null)
                        .WithMany()
